...
_The OK Corral and the Power of the Law (A Curious Poisson-Kernel Formula for a Parabolic Equation)_ is that if the intial number of Rascals and Varmints are then same, then the expected number of survivors satisfies
